 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Carawebs Code
 * Plugin URI:        http://example.com/carawebs-code-uri/
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-carawebs-code.php';
